/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: c58f291216ccd09c0800ec5690473af8)
// Runtime types generated with workerd@1.20250803.0 2025-03-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXT_INC_CACHE_KV: KVNamespace;
		EMAIL_FROM: "no-reply@notifications.pandacat.ai";
		EMAIL_FROM_NAME: "xCOA";
		EMAIL_REPLY_TO: "support@pandacat.ai";
		NEXTJS_ENV: string;
